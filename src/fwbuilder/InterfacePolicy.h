/* 
  ...
  $Id: InterfacePolicy.h 975 2006-09-10 22:40:37Z vkurland $
...
#ifndef __INTERFACEPOLICY_HH_FLAG__
#define __INTERFACEPOLICY_HH_FLAG__
...
class InterfacePolicy : public RuleSet  
{
    ...
    InterfacePolicy();
    InterfacePolicy(const FWObject *root,bool prepopulate);
    virtual ~InterfacePolicy();
    
    DECLARE_FWOBJECT_SUBTYPE(InterfacePolicy);
