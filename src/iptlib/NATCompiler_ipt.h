...
namespace fwcompiler {
	...
	/**
	 * separate TCP/UDP services with port ranges (can not be used with multiport)
	 */
        DECLARE_NAT_RULE_PROCESSOR(separatePortRanges);
	 ...
	 */
        DECLARE_NAT_RULE_PROCESSOR(separateSourceAndDestinationPorts);
