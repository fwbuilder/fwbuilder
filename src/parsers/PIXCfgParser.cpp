...
#line 971 "pix.g"
				importer->SaveTmpAddrToSrc(); *dbg << "(src) ";
#line 3926 "PIXCfgParser.cpp"
			}
			hostaddr_expr();
			if ( inputState->guessing==0 ) {
#line 972 "pix.g"
				importer->SaveTmpAddrToDst(); *dbg << "(dst) ";
#line 3932 "PIXCfgParser.cpp"
			}
			{
			switch ( LA(1)) {
			case INT_CONST:
...
#line 4663 "PIXCfgParser.cpp"
		}
		hostaddr_expr();
		if ( inputState->guessing==0 ) {
#line 991 "pix.g"
			importer->SaveTmpAddrToSrc(); *dbg << "(src) ";
#line 4669 "PIXCfgParser.cpp"
		}
		{
