...
#line 442 "PIXCfgParser.cpp"
		...
		else if ((LA(1) == NEWLINE) && (LA(2) == LINE_COMMENT)) {
			{
			}
			if ( inputState->guessing==0 ) {
#line 1062 "pix.g"
...
// "rip" "no" "nameif" "security-level" "shutdown" "switchport" 
