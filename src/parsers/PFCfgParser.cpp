...
const unsigned long PFCfgParser::_tokenSet_0_data_[] = { 2UL, 0UL, 0UL, 0UL };
// EOF 
const ANTLR_USE_NAMESPACE(antlr)BitSet PFCfgParser::_tokenSet_0(_tokenSet_0_data_,4);
const unsigned long PFCfgParser::_tokenSet_1_data_[] = { 2034UL, 0UL, 0UL, 0UL };
// EOF NEWLINE LINE_COMMENT COLON_COMMENT "timeout" WORD "pass" "drop" 
