<!--
   Filename:     FWObjectDatabase_2.0.4.xslt
   Author:       Vadim Kurland
   Build date:   12/04/2004
   Last changed: 12/04/2004
   Version:      1.0.0
   Description:  translates fwbuilder object database from v2.0.4 to v2.0.99
