<!--
   Filename:     FWObjectDatabase_2.0.12.xslt
   Author:       Vadim Kurland
   Build date:   04/13/2005
   Last changed: 04/13/2005
   Version:      1.0.0
   Description:  translates fwbuilder object database from v2.0.11 to v2.0.99
