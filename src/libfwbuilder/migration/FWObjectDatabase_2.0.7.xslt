<!--
   Filename:     FWObjectDatabase_2.0.7.xslt
   Author:       Vadim Kurland
   Build date:   05/20/2005
   Last changed: 05/20/2005
   Version:      1.0.0
   Description:  translates fwbuilder object database from v2.0.7 to v2.0.99
