<!--
   ...
   Build date:   10/30/2006
   Last changed: 10/30/2006
   Version:      1.0.0
   Description:  translates fwbuilder object database from v2.1.6 to v2.1.7
...
<xsl:template match="*[attribute::id='root']">
  ...
  <xsl:attribute name="version">2.1.7</xsl:attribute>
