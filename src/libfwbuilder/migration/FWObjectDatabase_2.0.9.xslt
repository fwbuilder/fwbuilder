<!--
   Filename:     FWObjectDatabase_2.0.9.xslt
   Author:       Vadim Kurland
   Build date:   10/22/2005
   Last changed: 10/22/2005
   Version:      1.0.0
   Description:  translates fwbuilder object database from v2.0.9 to v2.0.99
